...
class GPUModelRunner(
    ...
    def sample_tokens(
        ...
        with record_function_or_nullcontext("gpu_model_runner: ModelRunnerOutput"):
            ...
            output = ModelRunnerOutput(
                ...
                routed_experts_step=genome_output_fields["routed_experts_step"],
                routed_experts_step_indices=genome_output_fields[
                    "routed_experts_step_indices"
                ],
                prefix_learning_pairs_by_req=genome_output_fields[
                    "prefix_learning_pairs_by_req"
                ],
                prefix_learning_owner_by_req=genome_output_fields[
                    "prefix_learning_owner_by_req"
                ],
                async_prefix_learning_owner_by_req=genome_output_fields[
                    "async_prefix_learning_owner_by_req"
                ],
                prefix_router_placement_update=genome_output_fields[
    ...
    def init_routed_experts_capturer(self):
        ...
        if not (enable_capture or self.model_config.enable_return_routed_experts):
            self.routed_experts_initialized = False
        ...
        set_global_experts_capturer(self.routed_experts_capturer)
